...
public abstract class Hilt_HeadFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HeadFragment_GeneratedInjector) this.generatedComponent()).injectHeadFragment(UnsafeCasts.<HeadFragment>unsafeCast(this));
    }
  }
